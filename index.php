...
?>
    ...
    <div class="small-container">
        ...
        <div class="row">
            <div class="col-4">
                <img src="https://images.unsplash.com/photo-1491553895911-0055eca6402d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" alt="Nike Preto">
    ...
    <div class="offer">
        <div class="small-container">
            <div class="row">
                <div class="col-2">
                    <img src="https://images.unsplash.com/photo-1648126618308-9917edb2d0d2?q=80&w=387&auto=format&fit=crop" class="offer-img" alt="Tênis Exclusivo">
                </div>
                <div class="col-2">
                    <p>Disponível Exclusivamente na Json Calçados</p>
                    <h1>Yeezy Boost 700 "Wave"</h1>
                    <small>O design Wuppie que redefiniu a moda urbana nos anos 90.</small>
                    <br>
